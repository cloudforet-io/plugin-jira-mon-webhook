...
from schematics.types import DictType, StringType, ModelType, DateTimeType, BaseType
...
class EventModel(Model):
    ...
    occurred_at = DateTimeType(serialize_when_none=False)
    additional_info = DictType(BaseType(), default={})
